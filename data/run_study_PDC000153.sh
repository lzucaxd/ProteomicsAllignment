...
STUDY="PDC000153"
MANIFEST="${PDC000153_MANIFEST:-$SCRIPT_DIR/manifests/PDC000153_pdc_file_manifest.csv}"
...
if [[ ! -f "$MANIFEST" ]]; then
  ...
  echo "  $SCRIPT_DIR/manifests/PDC000153_pdc_file_manifest.csv"
  echo "Or set PDC000153_MANIFEST=/path/to/your_export.csv"
